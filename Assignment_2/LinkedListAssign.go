...
func main() {
	...
	myPlaylist.addSong("Senorita", "The Camila cabello")
	myPlaylist.addSong("Despacito", "Justib beeber")
	myPlaylist.addSong("Here With Me", "The Marshmello")
	myPlaylist.addSong("Memories", "Maroon")
